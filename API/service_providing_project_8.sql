...
insert  into `provider_ratings`(`id`,`provider_id`,`ratings_no`,`rating_avg`,`created_at`,`updated_at`) values 
(1,1,5,2.5,'2019-09-10 08:50:39',NULL);
...
insert  into `providers`(`id`,`user_id`,`name`,`description`,`logo`,`cover`,`address_id`,`coordinate_id`,`created_at`,`updated_at`) values 
(1,2,'Provider','Provider','sdfsdf','df 	dsfs',1,1,'2019-09-10 10:08:44',NULL);
...
insert  into `ratings`(`id`,`client_id`,`provider_id`,`stars_no`,`comment`,`created_at`,`updated_at`) values 
(1,1,1,3,'very bad','2019-09-08 07:18:20','2019-09-08 07:18:20'),
(2,1,1,3,'very bad','2019-09-10 06:01:39','2019-09-10 06:01:39'),
(3,1,1,3,'very bad','2019-09-10 06:01:57','2019-09-10 06:01:57');
...
insert  into `services`(`id`,`provider_id`,`name`,`unit_id`,`count`,`price`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`deleted_by`) values 
(1,1,'service',1,20,300,'2019-09-10 10:07:31',NULL,NULL,NULL,NULL,NULL);
